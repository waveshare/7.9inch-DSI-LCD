...
#Move driver file
sudo cp WS_7_9inchDSI400x1280_Touch.ko /lib/modules/$(uname -r)
sudo cp WS_7_9inchDSI400x1280_Screen.ko /lib/modules/$(uname -r)
sudo cp WS_7_9inchDSI400x1280_Touch.dtbo /boot/overlays
sudo cp WS_7_9inchDSI400x1280_Screen.dtbo /boot/overlays
...
#Install driver
sudo depmod
sudo modprobe WS_7_9inchDSI400x1280_Touch
sudo modprobe WS_7_9inchDSI400x1280_Screen
...
Data_Insertion config.txt  "dtoverlay=WS_7_9inchDSI400x1280_Screen"
#Data_Insertion config.txt  "# -------------touch---------------"
Data_Insertion config.txt  "dtparam=i2c_vc=on"
Data_Insertion config.txt  "dtoverlay=WS_7_9inchDSI400x1280_Touch,invertedx,invertedy"
